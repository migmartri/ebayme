...
class AuthenticatedGenerator < Rails::Generator::NamedBase
  ...
  def manifest
    recorded_session = record do |m|
      ...
      m.template 'roles/model.rb', File.join('app/models', class_path, "role.rb")
      m.template 'permissions/model.rb', File.join('app/models', class_path, "permission.rb")
      m.template 'roles/controller.rb', File.join('app/controllers', controller_class_path, "roles_controller.rb")
